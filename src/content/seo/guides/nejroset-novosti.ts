...
export const nejroset_novosti: SeoPageContent = {
  slug: "nejroset-novosti",
  type: "guide",
  title: "Новости нейросетей",
  description: "Новости мира нейросетей и искусственного интеллекта. Бесплатно, без регистрации.",
  index: false,
  canonical: 'https://ai-sphere.ru/nejroset-novosti',
