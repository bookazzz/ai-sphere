...
export const generator_nejroset: SeoPageContent = {
  slug: "generator-nejroset",
  type: "comparison",
  title: "Генератор нейросеть",
  description: "Универсальные AI-генераторы текста, идей, мемов, калькуляций. Бесплатно, без регистрации.",
  index: false,
  canonical: 'https://ai-sphere.ru/generator-nejroset',
