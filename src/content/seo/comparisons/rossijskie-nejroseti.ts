...
export const rossijskie_nejroseti: SeoPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      entries: [
        { name: 'AI-Sphere (ChatGPT, Claude, DeepSeek и др.)', rating: 9.2, pros: 'Каталог доступных мировых моделей, оплата в рублях, работа с файлами и изображениями', cons: 'Состав моделей зависит от актуального каталога провайдера', price: 'Пакеты кредитов по актуальным тарифам' },
